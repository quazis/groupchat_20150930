...
if (isset($_SESSION['username'])){
	echo '<b>Hello! ' . $_SESSION['username'] . ' | find out other members</b>';
...
$messagelast = show_message_last(); //get one last message each user key => value array
...
foreach ($users as $key => $value){
	...
	echo '</tr>';
        ...
        echo '<tr valign="top">';
        // message font color is changed here
	echo '<td><font color="#C0C0C0">' .$messagelast[$key]. '</font>';
        echo '</td>';
	echo '</tr>';
}
?>
