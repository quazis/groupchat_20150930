	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2" id="create-account">
			...
			<div class="col-md-6" align="center">
				<form action="newuser.php" method="post"><br>				
					...
					<div class="posts" align="center">
						<p class="para">
							<input id="policy" name="agree" type="checkbox" value="true"/><strong align="left" id="label-2" for="policy">I accept terms and conditions.</strong></p>
					</div>
